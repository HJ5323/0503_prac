...
void MyFunctions::InputStudentInfo(vector<MyFunctions::student_personal_info>& students)
{
    // 1. 사용자에게 학생 수 입력 받기
    int student_num;
    cout << "학생 수를 입력하세요: ";
...
// 학생 정보 출력
void MyFunctions::PrintStudentInfo(const vector<MyFunctions::student_personal_info>& students)
{
    cout << "\n<학생 정보>" << endl;
...
// 평균 나이 출력
void MyFunctions::PrintAverAge(const vector<MyFunctions::student_personal_info>& students)
{
    float sum_age = 0;
...
// 가장 빠른 생일 출력
void MyFunctions::PrintEarlyBirth(const vector<MyFunctions::student_personal_info>& students)
{
...
void MyFunctions::EditStudentInfo(vector<MyFunctions::student_personal_info>& students)
{
    string SearchName;
